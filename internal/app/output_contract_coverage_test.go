...
var outputContractCoverageInventory = map[string]outputContractCoverageEntry{
	"tool_catalog":        {Variants: []string{"success"}},
	...
	"task_manage":              {Variants: []string{"create", "block", "resume", "complete"}},
	"task_update":              {Variants: []string{"checkpoint", "final_review"}},
	"task_read":                {Variants: []string{"list", "get", "snapshot"}},
